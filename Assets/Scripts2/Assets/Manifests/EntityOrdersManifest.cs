...
{
    [CreateAssetMenu(fileName = "New Entity Orders Manifest", menuName = "RTS2/Manifest/Entity Orders Manifest")]
    public class EntityOrdersManifest : ScriptableObject
    {
        ...
        internal ICollection<string> GetEntityOrders(string entityIdentifier) {
            return entityOrdersDictionary[entityIdentifier].values;
        }
    }
}